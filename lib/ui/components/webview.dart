...
void main() => runApp(const MaterialApp(home: WebViewPowerBI()));
...
class WebViewPowerBI extends StatefulWidget {
  const WebViewPowerBI({super.key});

  @override
  State<WebViewPowerBI> createState() => _WebViewPowerBIState();
}
...
class _WebViewPowerBIState extends State<WebViewPowerBI> {
  ...
  void initState() {
    ...
    controller
      ...
      ..loadRequest(Uri.parse(this._urlLogin));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //DESABILITEI A BARRA DA WEBVIEW, POIS NÃO SE ADEQUA ÀS NECESSIDADES DO CLIENTE
      /*appBar: AppBar(
